...
def train_agent(env, episodes=50, verbose=True):
    ...
    for episode in range(episodes):
        ...
        while not done:
            ...
            # Print progress
            if verbose and (done or len(env.state) % 50 == 0):
...
def display_recommendation(cpn, student_profile, priorities, q_table_path):
    ...
    grade_predictor = joblib.load('D:\\Folders\\Downloads\\PersonalizedAdvisor-ahmed\\PersonalizedAdvisor-ahmed\\helper\\poly_reg_pipeline.pkl')
